    ...
    <%@ page import="java.util.*" %>
      <%@ page import="com.Package.Patient" %>
      <%@ page import="com.Package.*" %>
      <%@ page import="com.Package.HospitalManagementServlet" %>
       <%@ page import="java.util.*,com.Package.*" %>
...
Connection con=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/hospitalmanagement","root","R@jesh4375"); 
