...
public class Mailer {
	...
	public static void send(String to, String subject, String msg) {
		 ...
		 // TODO Auto-generated method stub
		  ...
		  final String user="spandanainturi4@gmail.com";//change accordingly final
		  String pass="spandana14";
		  ...
		  try { MimeMessage message = new
		  MimeMessage(session); message.setFrom(new InternetAddress(user));
		  message.addRecipient(Message.RecipientType.TO,new InternetAddress(to));
		  message.setSubject(subject); message.setText(msg);
